...
export function buildDecisionMakerSystemPrompt(): string {
  return [
    ...
    "- Always populate firstName (and lastName, if known) by splitting fullName -- e.g. fullName \"Shola",
    "  Akinlade\" means firstName \"Shola\", lastName \"Akinlade\". Only leave firstName null if fullName",
    "  itself is not a real person's name.",
